# Malformed: Wrapped Tables with Links
...
| Tool     | Link                                  | Notes                                                |
|----------|---------------------------------------|------------------------------------------------------|
| ESLint   | [Website](https://eslint.org)         | JavaScript linter with extensive rule configuration  |
| Prettier | [Code Formatter](https://prettier.io) | Opinionated code formatter supporting many languages |

## Mixed: some links wrapped, some not
